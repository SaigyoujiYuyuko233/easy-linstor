...
Source0: https://pkg.linbit.com/downloads/linstor/linstor-server-%{FILE_VERSION}.tar.gz

BuildRequires: systemd java-1.8.0-openjdk-headless java-1.8.0-openjdk-devel python3 systemd-rpm-macros
...
%build
rm -rf ./build/install
%{_builddir}/%{NAME_VERS}/gradlew %{GRADLE_TASKS} %{GRADLE_FLAGS}
...
- Fix gradle path
- Fix source download error: use https instead of http
- Add more BuildRequires
- Try fix: File must begin with "/": %{_unitdir}/linstor-controller.service
