...
%if %(test /sbin -ef /usr/sbin && echo 1 || echo 0)
%global _without_sbinsymlinks --without-sbinsymlinks
%endif
...
%bcond_with xen
%bcond_with 83support
%bcond_with 84support
%bcond_with drbdmon
...
%ifarch %{ix86} x86_64
%if %{with xen}
Requires: drbd-xen = %{version}-%{release}
%endif
%endif
%if %{with udev}
